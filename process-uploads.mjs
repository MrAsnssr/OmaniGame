...
const imagesToProcess = [
    { src: 'uploaded_image_1_1765064234624.jpg', dest: 'خطفة.png' },    // Singleplayer (red)
    { src: 'uploaded_image_0_1765064234624.jpg', dest: 'السبلة.png' },   // Multiplayer (green)
    { src: 'uploaded_image_2_1765064234624.jpg', dest: 'كبارية.png' },   // Leaderboard (white)
];
...
async function processImages() {
    for (const img of imagesToProcess) {
        ...
        try {
            // Convert to PNG, trim transparent borders
